...
public class ImageController {
    ...
    public String showImage(@PathVariable("title") String title, @PathVariable("imageId") Integer imageId, Model model) {
        ...
        //comments are added to the model such that it will display all the comments for that particular image
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        //Here the user id verified so that only the owner of the image can delete the image
        if(user.getId() == imageUser.getId()) {
            String tags = convertTagsToString(image.getTags());
            model.addAttribute("image", image);
            model.addAttribute("tags", tags);
            return "images/edit";
        }
        //otherwise the error is displayed as "Only the owner of the image can delete the image"
        else {
